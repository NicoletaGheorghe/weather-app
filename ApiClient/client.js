...
const weather_base_url = "https://api.open-meteo.com/v1/forecast?daily=temperature_2m_max,temperature_2m_min,uv_index_max,wind_speed_10m_max&hourly=temperature_2m&current=temperature_2m&forecast_days=7";
export default class ApiClient {
    ...
    async getWeather({ latitude, longitude }) {
        const params = {
            ...
            daily: "temperature_2m_min,temperature_2m_max,uv_index_max,wind_speed_10m_max",
            forecast_days: "7",
        };
